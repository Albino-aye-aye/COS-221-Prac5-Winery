...
addWineForm.addEventListener('submit', function (event) {
  ...
  if (addWineName.value === '')
  {
    ...
    setTimeout(function () {addWineName.style.backgroundColor = '';}, 2000);
  ...
  if (addVinification.value === '')
  {
    ...
    setTimeout(function () {addVinification.style.backgroundColor = '';}, 2000);
  ...
  if (!priceRegex.test(addPrice.value) || addPrice.value === '') 
  {
    ...
    setTimeout(function () { addPrice.style.backgroundColor = ''; }, 2000);
